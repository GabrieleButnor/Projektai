...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="login">
        <div>
        <h1 style="font-size:40px; color:cadetblue">Prisijungimas <img src="Images/doggie.png" width="70"/></h1>
        <%--<p>&nbsp;</p>--%>
        <h2 style="font-size:20px; color:cadetblue;" >Įveskite savo prisijungimo duomenis </h2>
